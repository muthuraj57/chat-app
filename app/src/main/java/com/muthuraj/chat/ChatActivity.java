...
public class ChatActivity extends Activity {
        ...
        sendButton.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View view)
            {
                ...
                if (!editText.getText().toString().equals("")) {
                    if(checkNetwork()) {
                        new SendMessage(getApplicationContext()).execute(sharedPreferences.getString(SignInActivity.name, "sendMsgSharedFailure"), receiver, editText.getText().toString(), "http://chat.muthuraj.tk/android_send_msg.php");
                        //To clear Text Field
                        editText.setText("");
                    }else
    ...
    private void repeat()
    {
        ...
        public void run() {
            ...
            try{
                if(checkNetwork())
                new FetchMsg(getBaseContext(), listView).execute(sharedPreferences.getString(SignInActivity.name, "senderShareDefFailure"),receiver,"http://chat.muthuraj.tk/android_fetch_msg.php");
                else
